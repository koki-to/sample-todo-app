...
abstract mixin class $TodoCopyWith<$Res> {
  factory $TodoCopyWith(Todo value, $Res Function(Todo) _then) =
      _$TodoCopyWithImpl;
  @useResult
  $Res call({int id, String title, bool isCompleted, DateTime createdAt});
}
...
extension TodoPatterns on Todo {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _Todo() when $default != null:
        return $default(
            _that.id, _that.title, _that.isCompleted, _that.createdAt);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(int id, String title, bool isCompleted, DateTime createdAt)
        $default,
  ) {
    final _that = this;
    switch (_that) {
