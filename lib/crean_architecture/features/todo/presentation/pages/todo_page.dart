...
class CreanArchitectureTodoPage extends ConsumerWidget {
  const CreanArchitectureTodoPage({super.key});
  ...
  Future<void> _showAddDialog(BuildContext context, WidgetRef ref) async {
    await showDialog<void>(
      ...
      builder: (context) => AddTodoDialog(
        onAdd: (title) => ref.read(todoProvider.notifier).addTodo(title),
      ),
    );
  }
}
